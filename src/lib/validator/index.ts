...
export const getFirstErrorConstraints = (err: ClassValidatorValidationError): { [key: string]: string } | undefined => {
...
export const validate = async <T>(
  ...
  if (errors.length > 0) {
    ...
    throw new httpErrors.BadRequestError(errorMessages.reverse()[0]);
  }
